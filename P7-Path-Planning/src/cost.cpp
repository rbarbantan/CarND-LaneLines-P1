...
map<string, float> get_helper_data(const Vehicle &vehicle, 
  ...
  //std::cout <<"intended: "<< intended_lane << ", " << lane_speed(predictions, intended_lane, vehicle.s + 60) << "||";
  //std::cout <<"final: "<< final_lane << ", " << lane_speed(predictions, final_lane, vehicle.s + 60) << "\n";
